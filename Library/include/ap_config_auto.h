...
/* Location of the MIME types config file, relative to the Apache root
   directory */
#define AP_TYPES_CONFIG_FILE "/Applications/MAMP/conf/apache/mime.types"
...
#define HTTPD_ROOT "/Applications/MAMP/Library"
...
#define SERVER_CONFIG_FILE "/Applications/MAMP/conf/apache/httpd.conf"
