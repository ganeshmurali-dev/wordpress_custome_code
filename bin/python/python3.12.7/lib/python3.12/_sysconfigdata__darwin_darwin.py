...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/Applications/MAMP/bin/python/python3.12.7/bin',
 'BINLIBDEST': '/Applications/MAMP/bin/python/python3.12.7/lib/python3.12',
 'BLDLIBRARY': '-L. -lpython3.12',
 'BLDSHARED': 'gcc -bundle -undefined dynamic_lookup '
              '-L/Applications/MAMP/Library/lib '
              '-L/Applications/MAMP/Library/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '.exe',
 'BUILDPYTHON': 'python.exe',
 'BUILD_GNU_TYPE': 'aarch64-apple-darwin21.6.0',
 'BUILD_SCRIPTS_DIR': 'build/scripts-3.12',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc',
 'CCSHARED': '',
 'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-O3 -Wall -I/Applications/MAMP/Library/include -fPIC '
           '-I/Applications/MAMP/Library/include -fPIC',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/Applications/MAMP/Library/include -fPIC',
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-L/Applications/MAMP/Library/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/Applications/MAMP/bin/python/python3.12.7' "
                "'--exec-prefix=/Applications/MAMP/bin/python/python3.12.7' "
                "'--enable-optimizations' '--enable-ipv6' "
                "'--with-openssl=/Applications/MAMP/Library' '--enable-shared' "
                "'--with-system-ffi' '--with-system-expat' "
                "'PKG_CONFIG=/Applications/MAMP/Library/bin/pkg-config' "
                "'CFLAGS=-I/Applications/MAMP/Library/include -fPIC' "
                "'LDFLAGS=-L/Applications/MAMP/Library/lib' 'LIBS=-lexpat'",
 'CONFINCLUDEDIR': '/Applications/MAMP/bin/python/python3.12.7/include',
 'CONFINCLUDEPY': '/Applications/MAMP/bin/python/python3.12.7/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Users/mamp/Desktop/build-Ordner/Python-3.12.7/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/Users/mamp/Desktop/build-Ordner/Python-3.12.7/lcov-report',
 ...
 'DESTDIRS': '/Applications/MAMP/bin/python/python3.12.7 '
             '/Applications/MAMP/bin/python/python3.12.7/lib '
             '/Applications/MAMP/bin/python/python3.12.7/lib/python3.12 '
             '/Applications/MAMP/bin/python/python3.12.7/lib/python3.12/lib-dynload',
 'DESTLIB': '/Applications/MAMP/bin/python/python3.12.7/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/Applications/MAMP/bin/python/python3.12.7/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXENAME': '/Applications/MAMP/bin/python/python3.12.7/bin/python3.12',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'aarch64-apple-darwin21.6.0',
 'INCLDIRSTOMAKE': '/Applications/MAMP/bin/python/python3.12.7/include '
                   '/Applications/MAMP/bin/python/python3.12.7/include '
                   '/Applications/MAMP/bin/python/python3.12.7/include/python3.12 '
                   '/Applications/MAMP/bin/python/python3.12.7/include/python3.12',
 'INCLUDEDIR': '/Applications/MAMP/bin/python/python3.12.7/include',
 'INCLUDEPY': '/Applications/MAMP/bin/python/python3.12.7/include/python3.12',
 ...
 'LDCXXSHARED': 'g++ -bundle -undefined dynamic_lookup '
                '-L/Applications/MAMP/Library/lib '
                '-L/Applications/MAMP/Library/lib',
 'LDFLAGS': '-L/Applications/MAMP/Library/lib -L/Applications/MAMP/Library/lib',
 ...
 'LDVERSION': '3.12',
 'LIBC': '',
 'LIBDEST': '/Applications/MAMP/bin/python/python3.12.7/lib/python3.12',
 'LIBDIR': '/Applications/MAMP/bin/python/python3.12.7/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code '
                    '-DNDEBUG -g -O3 -Wall '
                    '-I/Applications/MAMP/Library/include -fPIC '
                    '-I/Applications/MAMP/Library/include -fPIC -std=c11 '
                    '-Wextra -Wno-unused-parameter '
                    '-Wno-missing-field-initializers -Wstrict-prototypes '
                    '-Werror=implicit-function-declaration -fvisibility=hidden '
                    '-fprofile-instr-use=/Users/mamp/Desktop/build-Ordner/Python-3.12.7/code.profclangd '
 ...
 'LIBHACL_CFLAGS': '-I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE '
                   ...
                   '-DNDEBUG -g -O3 -Wall -I/Applications/MAMP/Library/include '
                   '-fPIC -I/Applications/MAMP/Library/include -fPIC -std=c11 '
                   '-Wextra -Wno-unused-parameter '
                   '-Wno-missing-field-initializers -Wstrict-prototypes '
                   '-Werror=implicit-function-declaration -fvisibility=hidden '
                   '-fprofile-instr-use=/Users/mamp/Desktop/build-Ordner/Python-3.12.7/code.profclangd '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Applications/MAMP/bin/python/python3.12.7/lib/pkgconfig',
 'LIBPL': '/Applications/MAMP/bin/python/python3.12.7/lib/python3.12/config-3.12-darwin',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.12.a',
 'LIBRARY_DEPS': 'libpython3.12.a libpython3.12.dylib',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lintl -ldl -lexpat -framework CoreFoundation',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'gcc',
 ...
 'LLVM_PROF_MERGER': '/usr/bin/xcrun llvm-profdata merge -output="$(shell '
                     'pwd)/code.profclangd" "$(shell pwd)"/*.profclangr',
 'LN': 'ln',
 'LOCALMODLIBS': '',
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Applications/MAMP/bin/python/python3.12.7/lib/python3.12',
 'MACOSX_DEPLOYMENT_TARGET': '11.0',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/Applications/MAMP/bin/python/python3.12.7/share/man',
 ...
 'MODBUILT_NAMES': 'array  _asyncio  _bisect  _contextvars  _csv  _heapq  '
                   ...
                   '_uuid  _scproxy  xxsubtype  _xxtestfuzz  _testbuffer  '
 ...
 'MODSHARED_NAMES': 'array _asyncio _bisect _contextvars _csv _heapq _json '
                    ...
                    '_curses_panel _sqlite3 _ssl _hashlib _uuid _scproxy '
 ...
 'MODULE_BINASCII_LDFLAGS': '-L/Applications/MAMP/Library/lib -lz',
 ...
 'MODULE_READLINE_CFLAGS': '-I/Applications/MAMP/Library/include',
 'MODULE_READLINE_LDFLAGS': '-L/Applications/MAMP/Library/lib -lreadline',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/Applications/MAMP/Library/include',
 'MODULE_ZLIB_LDFLAGS': '-L/Applications/MAMP/Library/lib -lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/Applications/MAMP/Library/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/Applications/MAMP/Library/lib   -lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/Applications/MAMP/Library/include',
 'MODULE__LZMA_LDFLAGS': '-L/Applications/MAMP/Library/lib -llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/Applications/MAMP/Library/lib/sqlite3/include '
                           '-I./Modules/_sqlite',
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/Applications/MAMP/Library/lib/sqlite3/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/Applications/MAMP/Library/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/Applications/MAMP/Library/lib  -lssl -lcrypto',
 ...
 'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -O3 -Wall -I/Applications/MAMP/Library/include -fPIC '
              '-I/Applications/MAMP/Library/include -fPIC',
 ...
 'PY_CORE_LDFLAGS': '-L/Applications/MAMP/Library/lib '
                    '-L/Applications/MAMP/Library/lib',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 1,
 'PY_HAVE_PERF_TRAMPOLINE': 0,
 'PY_LDFLAGS': '-L/Applications/MAMP/Library/lib '
               '-L/Applications/MAMP/Library/lib',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/Applications/MAMP/Library/lib '
                     '-L/Applications/MAMP/Library/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_LIBRARY_PATH=/Users/mamp/Desktop/build-Ordner/Python-3.12.7',
 'SCRIPTDIR': '/Applications/MAMP/bin/python/python3.12.7/lib',
 ...
 'SHELL': '/bin/sh -e',
 'SHLIBS': '-lintl -ldl -lexpat -framework CoreFoundation',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_LIBRARY_PATH=/Users/mamp/Desktop/build-Ordner/Python-3.12.7 '
               './python.exe -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_LIBRARY_PATH=/Users/mamp/Desktop/build-Ordner/Python-3.12.7 '
 ...
 'VERSION': '3.12',
 'WASM_ASSETS_DIR': './Applications/MAMP/bin/python/python3.12.7',
 'WASM_STDLIB': './Applications/MAMP/bin/python/python3.12.7/lib/python3.12/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/Users/mamp/Desktop/build-Ordner/Python-3.12.7',
 'abs_srcdir': '/Users/mamp/Desktop/build-Ordner/Python-3.12.7',
 'datarootdir': '/Applications/MAMP/bin/python/python3.12.7/share',
 'exec_prefix': '/Applications/MAMP/bin/python/python3.12.7',
 'prefix': '/Applications/MAMP/bin/python/python3.12.7',
 'srcdir': '.'}
