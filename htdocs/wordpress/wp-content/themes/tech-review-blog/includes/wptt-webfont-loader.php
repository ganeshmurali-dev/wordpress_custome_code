...
if ( ! class_exists( 'Tech_Review_Blog_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Tech_Review_Blog_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'tech_review_blog_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function tech_review_blog_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Tech_Review_Blog_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'tech_review_blog_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function tech_review_blog_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Tech_Review_Blog_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
