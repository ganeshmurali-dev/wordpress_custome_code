<?php
if ( ! class_exists( 'News_Report_Featured_Posts_Widget' ) ) {
	/**
	 * Adds News Report Featured Posts Widget.
	 */
	class News_Report_Featured_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$featured_posts_widget = array(
				...
				'description' => __( 'Retrive Featured Posts Widgets', 'news-report' ),
			);
			parent::__construct(
				'news_report_featured_posts_widget',
				__( 'Adore Widget: Featured Posts Widget', 'news-report' ),
						...
						<div class="post-item post-list">
							...
							<div class="post-item-content">
								...
								<div class="post-exerpt">
									...
									$content = wp_kses_post( wp_trim_words( $content, 40 ) );
									?>
