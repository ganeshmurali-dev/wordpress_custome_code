<?php
if ( ! class_exists( 'News_Report_Most_Read_Widget' ) ) {
	/**
	 * Adds News Report Most Read Widget.
	 */
	class News_Report_Most_Read_Widget extends WP_Widget {
		...
		public function __construct() {
			$most_read_widget = array(
				...
				'description' => __( 'Retrive Most Read Widgets', 'news-report' ),
			);
			parent::__construct(
				'news_report_most_read_widget',
				__( 'Adore Widget: Most Read Widget', 'news-report' ),
				$most_read_widget
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			$most_read_post_count  = isset( $instance['number'] ) ? absint( $instance['number'] ) : 4;
			...
			if ( ! empty( $most_read_title || $viewall_button_label ) ) {
				?>
			...
			<div class="adore-widget-body">
				<div class="most-read-widget-wrapper">
					...
					$most_read_widgets_args = array(
						'post_type'      => 'post',
						'posts_per_page' => absint( $most_read_post_count ),
		...
		public function form( $instance ) {
			...
			<p>
				...
				<input class="tiny-text" id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="number" step="1" min="1" max="8" value="<?php echo absint( $most_read_post_count ); ?>" size="3" />
			</p>
			<p>
